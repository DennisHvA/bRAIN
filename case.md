...
## Data
Een weer API (KNMI heeft hier een API voor)
Oppervlakte van daken
Aantal regenpijpen (kan ook 'ingevuld' worden door de gebruiker)
Volume regenton (kan ook 'ingevuld' worden door de gebruiker)
